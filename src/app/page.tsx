...
export default function HomePage() {
  ...
  const footerGroups = toFooterGroups();

  const identityDisclaimer =
    identity.dataStatus === "verified"
      ? undefined
      : identity.mockDisclaimer;

  return (
    <>
      <SiteHeader items={navItems} pathname="/" />
      ...
      <main>
        ...
        <CommunityTestimonials
          testimonials={testimonials.map((item) => ({
            ...
            programmeLabel: item.programmeSlug
              ? PROGRAMME_LABELS[item.programmeSlug]
              : undefined,
        ...
        <FaqSection
          items={faqs.map((faq) => ({
            ...
            answer: faq.answer,
            mockDisclaimer:
              faq.dataStatus === "verified" ? undefined : faq.mockDisclaimer,
          }))}
        />
      </main>
      ...
      />
      <StickyCtaBar pathname="/" href="/trial" />
    </>
  );
}

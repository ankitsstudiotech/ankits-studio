...
export default function TrialPage() {
  ...
  return (
    ...
    <main className="pulse-page flex flex-col">
      ...
      <div className="grid w-full max-w-[var(--layout-content)] gap-10 px-[var(--layout-gutter)] py-[var(--spacing-section)] lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.2fr)] lg:items-start lg:gap-12">
